...
const designBox = document.querySelectorAll(".design-box");
...
// Done to prevent three design boxes coming on page launch/refresh
...
designBox.forEach((box) => {
  box.addEventListener("mouseover", () => clickSound.play());
});
